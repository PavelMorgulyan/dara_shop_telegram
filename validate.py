...
async def check_pdf_document_payment(
    ...
    if not receiver_name_bool:
        ...
        return {
            "result": False,
            "report_msg": MSG_ERROR_CHECK_VALIDATE_ORDER_PRICE % price,
        }

    elif not phone_number_bool:
        return {
            "result": False,
            "report_msg": MSG_ERROR_CHECK_VALIDATE_NOT_CORRECT_ADMIN_PHONE_NUMBER
            % price,
        }
        ...
        return {
            "result": False,
            "report_msg": MSG_ERROR_CHECK_VALIDATE_NOT_CORRECT_CHECK_DOCUMENT % price,
        }
...
async def check_photo_payment(
    message: types.Message, user_id: int, price: str, file_name: str, file_id
) -> dict[str, bool | str]:
