...
MSG_NO_CORRECT_INFO_TO_SEND = (
    "Прости, но вы ввели неверные данные. " "Пожалуйста, попробуй еще раз."
)
...
MSG_CLIENT_LOAD_PHOTO = (
    "📎 Хорошо, загрузи свой эскиз, пожалуйста. \n\n"
...
MSG_ADMIN_SET_ANOTHER_PRICE = "Укажи другую цену"
...
MSG_TATTOO_ORDER_CLIENT_CHOICE_BODY_LATER = (
    "Не проблема, выберем с тобой место для тату позже."
)
...
MSG_NO_SCHEDULE_IN_TABLE = (
    "⭕️ Прости, но у вас еще нет дат в расписании в таблице в этом статусе."
)

MSG_NO_SCHEDULE_PHOTO_IN_TABLE = (
    "⭕️ Прости, но у вас еще нет фотографий расписания в таблице."
)
...
MSG_DO_ADMIN_WANT_TO_NOTIFY_CLIENT = (
    "Хотите оповестить пользователя об изменении в расписании?"
)
...
MSG_CLIENT_DO_WANT_ADD_ANOTHER_PHOTO_OR_VIDEO_BODY = (
    "❔ Хотите добавить еще фотографию или видео?"
)
...
MSG_GET_DESCRIPTION_TATTOO_FROM_CLIENT = (
    "💬 Хорошо, давай попробуем создать эскиз тату из твоего описания.\n\n"
)

MSG_GET_DESCRIPTION_TATTOO_FROM_ADMIN = (
    "Хорошо, давай попробуем создать изображение модели девушки из твоего описания.\n\n"
)
