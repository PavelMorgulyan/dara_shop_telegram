...
MSG_NO_CORRECT_INFO_TO_SEND = 'Прости, но вы ввели неверные данные. '\
...
MSG_CLIENT_SUCCESS_CHOICE_PHOTO = '📷 Отлично, вы выбрали фотографию '\
...
MSG_CLIENT_DONT_HAVE_SKETCH_ORDERS = '⭕️ У вас пока нет заказов эскизов для оплаты.\n\n'\
    f'{MSG_DO_CLIENT_WANT_TO_CREATE_ORDER}'
    
MSG_CLIENT_DONT_HAVE_GIFTBOX_ORDERS = '⭕️ У вас пока нет гифтбоксов для оплаты.\n\n'\
    f'{MSG_DO_CLIENT_WANT_TO_CREATE_ORDER}'
...
MSG_NO_PRICE_LIST_IN_DB = '❌ Прости, у вас пока нет прайс-листа.\n'\
...
MSG_NO_SCHEDULE_CONSULTATION = \
    ...
    ' для консультаций.\n\n '\
    '🗓 А пока, при заказе консультации татуировки вы можете выбрать '\
    'свою дату, которая удобна для вас.\n\n'\
...
MSG_DELETE_FUNCTION_NOTE = '❗️❗️❗️ Данная функция полностью удаляет итем из базы'
...
MSG_CLIENT_WANT_TO_FILL_ORDER_NOTE = '❔ Хотите чего-нибудь добавить к описанию своего заказа?'

CLIENT_WANT_TO_CHANGE_MORE = '❔ Хотите что-нибудь еще изменить в этом тату?\n\n' \
...
MSG_NO_CERT_TO_PAY = '⭕️ У вас пока нет сертификатов для оплаты.\n\n'\
...
MSG_NO_TATTOO_IN_TABLE = '⭕️ Прости, но у вас еще нет тату в таблице.'

MSG_NO_SCHEDULE_IN_TABLE = '⭕️ Прости, но у вас еще нет дат в расписании в таблице в этом статусе.'

MSG_NO_SCHEDULE_PHOTO_IN_TABLE = '⭕️ Прости, но у вас еще нет фотографий расписания в таблице.'

MSG_TO_GET_SCHEDULE = '🗓 Мое расписание появилось выше.\n❕ Выбери дату из расписания, пожалуйста. '

MSG_TO_NO_SCHEDULE = \
    'Пока дат для тату в этом месяце нет, '\
...
MSG_DO_ADMIN_WANT_TO_NOTIFY_CLIENT = 'Хотите оповестить пользователя об изменении в расписании?'

MSG_PLS_SEND_TATTOO_PHOTO_OR_CANCEL_ACTION = \
    '📎 Пожалуйста, загрузи фотографию тату через файлы или отмени действие'

MSG_CLIENT_DO_WANT_ADD_ANOTHER_PHOTO_OR_VIDEO_BODY = '❔ Хотите добавить еще фотографию или видео?'
...
MSG_ANSWER_AOUT_RESULT_TATTOO_FROM_AI = 'Вот ваша фотография. Хотите попробовать еще? '\
...
MSG_ERROR_CHECK_VALIDATE_NOT_CORRECT_ADMIN_PHONE_NUMBER = \
    ...
    f"Пожалуйста, отправьте чек на сумму %s на номер телефона +7(925)885-07-87"
...
MSG_ERROR_CHECK_VALIDATE_NOT_CORRECT_CHECK_DOCUMENT = \
    ...
    f"Пожалуйста, отправьте именно чек о переводе на сумму %s на номер телефона +7(925)885-07-87"    