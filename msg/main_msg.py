...
MSG_INFO_START_ORDER = (
    "💬 Данный диалог построен на том, что бот задает ряд вопросов, а вы отвечаете на них.\n"
    ...
    "данная информация для него не в рамках заданного вопроса, и ответ он не принимат не будет."
)
...
MSG_WHICH_ADMIN_ORDER_WANT_TO_SEE = "Какой заказ хочешь посмотреть?"
