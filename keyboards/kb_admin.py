...
"""
    ...
    Отложен — заказ ещё не обработан, так как в нём содержатся товары,"
    " которых нет в наличии или нет даты сеанса.
...
client_want_to_try_another_later_img = {
    ...
    "client_want_to_get_example_text_for_ai_img": 
        "Хочу примеры текста изображений",
    "description_ai_generation_img": 
        "Хочу подробный текст с описанием о создании изображения",
